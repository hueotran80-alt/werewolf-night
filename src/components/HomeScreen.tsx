...
export const HomeScreen: React.FC<Props> = ({
  ...
  const generateRandomName = () => {
    const prefixes = ['Thợ Săn', 'Tiên Tri', 'Bảo Hộ', 'Kỵ Sĩ', 'Lãng Khách', 'Phù Thủy', 'Ẩn Sĩ', 'Quý Tộc'];
    const names = ['Bóng Đêm', 'Ánh Trăng', 'Ngân Hà', 'Huyết Tộc', 'Rừng Sâu', 'Gió Lạnh', 'Bình Minh', 'Hoàng Hôn'];
      ...
      <main className="relative z-10 w-full max-w-4xl mx-auto px-4 py-8 flex flex-col items-center text-center space-y-8 my-auto">
        ...
        <div className="w-full max-w-md p-5 rounded-3xl bg-zinc-950/90 border border-zinc-800/90 shadow-2xl space-y-4 text-left">
          <div>
            <label className="text-[11px] font-bold text-zinc-400 uppercase tracking-wider block mb-1.5">
              Biệt Danh Của Bạn (In-Game Nickname)
            </label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-3xl pt-4">
          ...
          >
            ...
            <div>
              <div className="font-bold text-xs text-white font-serif">13 THẺ BÀI & VAI TRÒ</div>
          ...
          >
            ...
            <div>
              <div className="font-bold text-xs text-white font-serif">LUẬT CHƠI TÂN THỦ</div>
              <p className="text-[11px] text-zinc-400 mt-0.5">
