...
function GameRoot() {
  ...
  return (
    <div className="min-h-screen bg-[#05070E] text-zinc-100 flex flex-col justify-between relative overflow-x-hidden">
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-2 sm:px-4 py-3 sm:py-4 flex-1 flex flex-col">
        <VoiceCallBar />
